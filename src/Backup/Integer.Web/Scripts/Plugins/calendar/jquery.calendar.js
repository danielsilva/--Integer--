...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        var def = {
            ...
            * danielnascimento
            *
            * @description {Config} hasAllDayEvent
            * {Boolean} If the calendar supports all day events
            */
        ...
        function render() {
            ...
            var showday = new Date(option.showday.getFullYear(), option.showday.getMonth(), option.showday.getDate(),1,0,0);
        ...
        function BuilderMonthBody(htb, showday, startday, events, bodyHeight) {
            ...
            var firstdate = new Date(showday.getFullYear(), showday.getMonth(), 1, 1, 0, 0);
            ...
            option.vend = enddate;
            option.datestrshow = showday.format("F Y");// danielnascimento - era: CalDateShow(startdate, enddate);
        ...
        function BuildMonthDayEvent(e, cday, length) {
            ...
            var cen;
            if (!e.allday && !sf) {
                //cen = pZero(e.st.hour) + ":" + pZero(e.st.minute) + " " + e.event[1]; <daniel> tirei o horario da caixa do evento
                cen = e.event[1];
            }
            else {
                cen = e.event[1];
            ...
            //content.push(i); <daniel> retirei o icone do relogio
            if (e.reevent)
            { content.push(i2); }
...
//                        } catch (e) { }
        ...
        function tc(d) {
            function zc(c, i) {
                var d = "";
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                //<daniel>temparr.push(i18n.xgcalendar.update_detail, ' <StrONG>&gt;&gt;</StrONG></SPAN></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class=bubble-sprite></div></div></div>');
